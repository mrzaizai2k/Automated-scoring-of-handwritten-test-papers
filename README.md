...
<p align="center"><img src="doc/removeline_122/namecrop_giaythi5.jpg" width="400"></p>
<p align="center"><i>Hình 4. Image after removing line </i></p>

## 4. Word segmentation
I have compared between EAST and Scale Space techniques
You can see the result of EAST here

<p align="center"><img src="doc/timvanbanviettay3.jpg" width="400"></p>
<p align="center"><i>Hình 5. EAST result </i></p>

Pretty good hah! But those disadvantages made me decide to choose Scale Space technique:
* Both width and height must be resized to be multiples of 32 
* Working good on the whole test paper but bad on the small iamges that we have cropped
...
<p align="center"><img src="doc/wordImg_0.jpg" width="300"></p>
...
I will briefly describe the model cause you can easily find paper about this model cause it's too famous
...
I also use Batch Normalization, Drop out,... You can find the model structure in `source/word_model.py`.Both name and studen ID Recognition share the same model
...
You can find the `.h5` model [here](https://drive.google.com/drive/folders/1z2GdAg8uz-ZCni1glbG1A-M6f7-R_6Y2?usp=sharing) because GitHub don't allow me to upload file bigger than 25Mb
